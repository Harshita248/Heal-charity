!(function (a, b) {
  ...
  (o.event = {
    ...
    o.each({ mouseenter: "mouseover", mouseleave: "mouseout" }, function (
      a,
      b
    ) {
      o.event.special[a] = {
  ...
  (o.offset = {
    ...
    o.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function (
      b,
      c
    ) {
      var d = "pageYOffset" === c;
    ...
    o.each({ Height: "height", Width: "width" }, function (a, b) {
      o.each({ padding: "inner" + a, content: b, "": "outer" + a }, function (
        c,
        d
      ) {
        o.fn[d] = function (d, e) {
